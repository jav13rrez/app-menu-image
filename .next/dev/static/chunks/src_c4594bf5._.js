                ...
                "StepLoading.useEffect": async ()=>{
                    try {
                        ...
                        const poll = {
                            "StepLoading.useEffect.poll": async ()=>{
                                ...
                                if (result.status === "completed" && result.result) {
                                    ...
                                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$wizard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWizardStore"].getState().setError(result.error || "Generation failed");
                                } else {
                        ...
                        if (!cancelledRef.current) {
                            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$wizard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWizardStore"].getState().setError(e instanceof Error ? e.message : "Unknown error");
                        }
                    }
                }
            })["StepLoading.useEffect"]();
...
function StepCanvas() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StepCanvas.useEffect": ()=>{
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fabric$2f$dist$2f$index$2e$min$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FabricImage"].fromURL(store.generatedImageUrl, {
                crossOrigin: "anonymous"
            }).then({
                "StepCanvas.useEffect": (img)=>{
    ...
    const addTextTemplate = (idx)=>{
        ...
        if (activeTemplate !== null) {
            const objects = canvas.getObjects().filter((o)=>o instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fabric$2f$dist$2f$index$2e$min$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Textbox"]);
            objects.forEach((o)=>canvas.remove(o));
        }
        const tpl = TEXT_TEMPLATES[idx];
        const text = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fabric$2f$dist$2f$index$2e$min$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Textbox"](tpl.text, {
            left: size.w / 2,
            top: size.h * 0.85,
            originX: "center",
            originY: "center",
...
_s(StepCanvas, "h+lW9vIVaob7VO7K6u5ohgBi8x0=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2f$wizard$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useWizardStore"]
    ];
});
...
//# sourceMappingURL=src_c4594bf5._.js.map